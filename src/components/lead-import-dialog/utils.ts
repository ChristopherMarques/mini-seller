 ...
 */
export const validateLead = (lead: any, index: number, t: (key: string) => string): ValidationResult => {
  const errors: string[] = [];
 ...
 */
export const validateManualLead = (manualLead: ManualLeadForm, t: (key: string) => string): ValidationResult => {
  const errors: string[] = [];
 ...
 */
export const processJsonImport = (jsonInput: string, t: (key: string) => string) => {
 ...
 */
export const getImportSuccessMessage = (validCount: number, errorCount: number, t: (key: string) => string): string => {
